...
fun main() {
    ...
    /*Дополнительно вбил аргументы,
    чтобы преподавателям быстрее было проверять
    несколько значений*/

    println("$name был(а) в сети ${agoToText(2_500)}.")
    println("$name был(а) в сети ${agoToText(15_700)}.")
    println("$name был(а) в сети ${agoToText(86_444)}.")
    println("$name был(а) в сети ${agoToText(257_200)}.")
    println("$name был(а) в сети ${agoToText(308_000)}.")
}
